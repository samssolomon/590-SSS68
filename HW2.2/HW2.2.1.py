...
#USER PARAMETERS
IPLOT=True
#INPUT_FILE='planar_x1_x2_y.json'; NFIT = 3 #To define the dataset
INPUT_FILE='planar_x1_x2_x3_y.json'; NFIT = 4 #To define the dataset
FILE_TYPE="json"
PARADIGM='batch'
model_type="linear"

#DEFINE X_KEYS BASED ON NUMBER OF PARAMETERS
X_KEYS=[]
...
with open(INPUT_FILE) as f:
	my_input = json.load(f)  #read as a dictionary
